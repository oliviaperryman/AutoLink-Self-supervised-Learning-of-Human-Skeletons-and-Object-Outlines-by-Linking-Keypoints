...
class TrainSet(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        transformation_matrix = self.compute_transformation(subject_index, self.cameras[0], self.cameras[1])

        return {'img': multiviews[self.cameras[0]], 'img_rotated': multiviews[self.cameras[1]], 'transformation_matrix': transformation_matrix }
